...
public class Model {
	...
	static {
		...
		for (int i = 0; i < 256; i++) {
			anIntArray265[i] = (int) (Math.sin(i * 0.02454369D) * 32768D);
			anIntArray265[i + 256] = (int) (Math.cos(i * 0.02454369D) * 32768D);
		}

		for (int j = 0; j < 1024; j++) {
			anIntArray266[j] = (int) (Math.sin(j * 0.00613592315D) * 32768D);
			anIntArray266[j + 1024] = (int) (Math.cos(j * 0.00613592315D) * 32768D);
		}
	...
	public Model(byte abyte0[], int i, boolean flag) {
		...
		anInt307 = 512;
		anInt308 = 32;
		int j = DataOperations.getShort(abyte0, i);
		i += 2;
		int k = DataOperations.getShort(abyte0, i);
		i += 2;
		method174(j, k);
		...
		for (int l2 = 0; l2 < k; l2++) {
			...
			for (int i3 = 0; i3 < anIntArray235[l2]; i3++) {
				if (j < 256) {
					...
					anIntArrayArray236[l2][i3] = DataOperations.getShort(abyte0, i);
					i += 2;
				}
			}
	...
	public Model(Model aclass5[], int i) {
		anInt246 = 1;
		aBoolean247 = true;
		aBoolean254 = true;
		aBoolean255 = false;
	...
	public Model(Model aclass5[], int i, boolean flag, boolean flag1, boolean flag2, boolean flag3) {
		anInt246 = 1;
		aBoolean247 = true;
		aBoolean254 = true;
		aBoolean255 = false;
	...
	public void method178(Model aclass5[], int i, boolean flag) {
		int j = 0;
		int k = 0;
		for (int l = 0; l < i; l++) {
	...
	public Model[] method182(int i, int j, int k, int l, int i1, int j1, int k1, boolean flag) {
		...
		Model aclass5[] = new Model[j1];
		for (int l2 = 0; l2 < j1; l2++) {
			if (ai[l2] > k1)
				ai[l2] = k1;
			aclass5[l2] = new Model(ai[l2], ai1[l2], true, true, true, flag, true);
	...
	public void method201(int i, int j, int k, int l, int i1, int j1, int k1, int l1) {
		method200();
		if (anInt252 > Camera.anInt463 || anInt253 < Camera.anInt462 || anInt248 > Camera.anInt459 || anInt249 < Camera.anInt458 || anInt250 > Camera.anInt461
				|| anInt251 < Camera.anInt460) {
			aBoolean247 = false;
			return;
		}
		aBoolean247 = true;
	...
	public Model method203() {
		Model aclass5[] = new Model[1];
		aclass5[0] = this;
		Model model = new Model(aclass5, 1);
	...
	public Model method204(boolean flag, boolean flag1, boolean flag2, boolean flag3) {
		Model aclass5[] = new Model[1];
		aclass5[0] = this;
		Model model = new Model(aclass5, 1, flag, flag1, flag2, flag3);
		model.anInt245 = anInt245;
		return model;
	}
